...
function ekstrak_hash_file_zip(){
	echo -e "${p}[${b}*${p}] Mengekstrak hash file ZIP...${r}"
        ...
        hash_file_zip=$(/usr/share/john/run/zip2john "${file_zip}" 1> "${nama_file_hash_file_zip}" 2> "error.txt")
...
function ekstrak_hash_file_rar(){
	echo -e "${p}[${b}*${p}] Mengekstrak hash file RAR...${r}"
        ...
        hash_file_rar=$(/usr/share/john/run/rar2john "${file_rar}" 1> "${nama_file_hash_file_rar}" 2> "error.txt")
...
function ekstrak_hash_file_7z(){
        ...
        hash_file_7z=$(/usr/share/john/run/7z2john.pl "${file_7z}" 1> "${nama_file_hash_file_7z}" 2> "error.txt")
...
function ekstrak_hash_file_pdf(){
	echo -e "${p}[${b}*${p}] Mengekstrak hash file PDF...${r}"
        ...
        hash_file_pdf=$(/usr/share/john/run/pdf2john.pl "${file_pdf}" 1> "${nama_file_hash_file_pdf}" 2> "error.txt")
...
function ekstrak_hash_file_office(){
	echo -e "${p}[${b}*${p}] Mengekstrak hash file Office...${r}"
        ...
        hash_file_office=$(/usr/share/john/run/office2john.py "${file_office}" 1> "${nama_file_hash_file_office}" 2> "error.txt")
